...
If you'd like to run Rclown on your own server while having the freedom to make changes to its code, we recommend deploying it with [Kamal](https://kamal-deploy.org/).
...
> **Just want to run Rclown without code changes?** See [Docker Deployment](docker-deployment.md) for a simpler setup using pre-built images.

### 1. Fork the repository

Start by forking the Rclown repository to your own GitHub account. This lets you make changes and track your customizations.
...
# HTTP Basic Auth for the dashboard (required)
...
Rclown includes helpful Kamal aliases:
